...
- Для разовой проверки города DEV принимает приблизительную геолокацию, только
  если расстояние до ресторана плюс заявленная погрешность не превышает настроенный
  радиус. Отдельный production-порог точности 200 м в DEV не применяется.
  Отрицательная, нечисловая или превышающая радиус погрешность отклоняется до
  преобразования в integer. Production сохраняет свою прежнюю настройку точности.
