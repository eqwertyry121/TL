...
- Один заметный фирменный сигнал только при появлении нового order ID: короткий
  яркий notification-пинг, тёплый ответный тон и одно более тихое эхо; общая
  длительность около 2,9 секунды. В нём нет циклического чередования нот,
  похожего на сирену. Одновременные события не накладывают несколько сигналов
  друг на друга.
