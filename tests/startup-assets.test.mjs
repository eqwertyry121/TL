...
test("client shows combos inline without a separate transition control", () => {
  ...
  for (const title of ["FAMILY BOX", "SOLO MODE", "DOUBLE DATE", "SWEET MIX", "GREEN MIX"]) assertIncludes(fixtures, title);
  ...
  assertIncludes(fixtures, 'staticMedia("family-box-card")');
