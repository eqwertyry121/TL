...
VALUES (
  '/media/menu/full-house-card.jpg', '/media/menu/full-house-card_thumb.jpg',
  960, 640, 130961, 'image/jpeg',
  480, 320, 35732, 'image/jpeg'
)
...
UPDATE menu_items
SET title_ru = 'FULL HOUSE',
    title_sr = 'FULL HOUSE',
    title_en = 'FULL HOUSE',
    photo_path = '/media/menu/full-house-card.jpg',
    version = version + 1,
    updated_at = now()
